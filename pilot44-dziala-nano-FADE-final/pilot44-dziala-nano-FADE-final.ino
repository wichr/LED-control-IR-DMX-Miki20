...
void loop() {
   ...
   // Serial.print("0x");
    ...
    if ( results.value != 0xFFFFFFFF) {
      switch (results.value) {
           ...
           case OFF           : r = g = b = 0;   fade=0; break; ///w=0 timer.time(STOP);
           case RED           : r=255;g=0;b=0;   fade=0;break; ///w=0
           case GREEN         : RGB(0x0000FF00); fade=0;break;
           case BLUE          : RGB(0x000000FF); fade=0;break;
           case WHITE         : r=255;g=255;b=255;fade=0;break;  //RGB(0x00FFFFFF); break;
           case ORANGE        : RGB(0x00FF7F00); fade=0;break;
           case YELLOW_DARK   : RGB(0x00FFAA00); fade=0;break;
           case YELLOW_MEDIUM : RGB(0x00FFD400); fade=0;break;
           case YELLOW_LIGHT  : RGB(0x00FFFF00); fade=0;break;
           case GREEN_LIGHT   : RGB(0x0000FFAA); fade=0;break;
           case GREEN_BLUE1   : RGB(0x0000FFFF); fade=0;break;
           case GREEN_BLUE2   : RGB(0x0000AAFF); fade=0;break;
           case GREEN_BLUE3   : RGB(0x000055FF); fade=0;break;
           case BLUE_RED      : RGB(0x00000080); fade=0;break;
           case PURPLE_DARK   : RGB(0x003F0080); fade=0;break;
           case PURPLE_LIGHT  : RGB(0x007A00BF); fade=0;break;
           case PINK          : RGB(0x00FF00FF); fade=0;break;
           case PINK_LIGHT    : RGB(0x00AA00FF); fade=0;break;
           case PINK_MED      : RGB(0x00FF00AA); fade=0;break;
           case BLUE_LIGHT    : r=50;g=50;b=255; fade=0;break; ///w=0
           case BLUE_MED      : r=20;g=20;b=200; fade=0;break; ///w=0
           ...
           case FADE3          :  r= 0;g= 0;b= 0; fade=4 ; timer.begin(CYCLE_DELAY_TIME);  full_program=0; break; ///w=0
           case FADE7          :  r= 0;g= 0;b= 0; fade=12 ; timer.begin(CYCLE_DELAY_TIME);  full_program=0; break; ///w=0
           case JUMP3          :  r= 0;g= 0;b= 0; fade=34 ; timer.begin(CYCLE_DELAY_TIME);  full_program=0; break; ///w=0
           case JUMP7          :  r= 0;g= 0;b= 0; fade=42 ; timer.begin(CYCLE_DELAY_TIME);  full_program=0; break; ///w=0
           case FLASH          :  r= 0;g= 0;b= 0; fade=23;  timer.begin(FADE_IN_TIME/8);   full_program=0; break; ///w=0  
           case AUTO           :  r= 0;g= 0;b= 0; fade=44;  timer.begin(FADE_IN_TIME/8);  full_program=20;  break; 
  ...
  ///fade
   ...
   if(full_program>0){fade=44; full_program=20 ;}else   fade=4;
     ...
     r=blinkUpdate(); b=0; g=0; 
  }else   if (fade == 3){   //r=0;
    g=blinkUpdate();  b=0; r=0; 
  }else   if (fade == 4){    
     b=blinkUpdate();  g=0; r=0; 
  }
    else    if (fade == 5){    
   if(full_program>0)fade=4 ;else    fade=12;
    ...
    if(full_program>0) ;else    fade++;
       r=g=b=blinkUpdate();
       
 
    }else   if (fade == 14){ if(full_program>0) ;else    fade++; 
       r=g=blinkUpdate();
      
       b=0;
    }else   if (fade == 15){  if(full_program>0) ;else   fade++; 
       g=blinkUpdate();
       b=0;
       r=0; 
    }else   if (fade == 16){   if(full_program>0) ;else   fade++;
       g=b=blinkUpdate();
       
       r=0;  
    }else   if (fade == 17){   if(full_program>0) ;else   fade++;
       b=blinkUpdate();
       r=0; 
       g=0; 
    }else   if (fade == 18){  if(full_program>0) ;else    fade++;
       r=b=blinkUpdate();
  ...
  //jump
   ...
   if(full_program>0)fade=12;else   fade=34;
     ...
     r=jumpUpdate(); b=0; g=0; 
  }else   if (fade == 33){   //r=0;
    g=jumpUpdate();  b=0; r=0; 
  }else   if (fade == 34){    
     b=jumpUpdate();  g=0; r=0; 
  }
     else   if (fade == 35){    
   ...
   if ( EppromUpdate() == 1)     { r = EEPROM.read(1); g = EEPROM.read(2); b = EEPROM.read(3);  }
   else if (EppromUpdate() == 2) { EEPROM.write(1 , r); EEPROM.write(2 , g); EEPROM.write(3 , b); }
  } 
   else if (fade == 52){   
   if ( EppromUpdate() == 1)     { r = EEPROM.read(4); g = EEPROM.read(5); b = EEPROM.read(6);  }
   else if (EppromUpdate() == 2) {  EEPROM.write(4 , r); EEPROM.write(5 , g); EEPROM.write(6 , b); }
  } 
     else if (fade == 53){   
   if ( EppromUpdate() == 1)     { r = EEPROM.read(7); g = EEPROM.read(8); b = EEPROM.read(9);  }
   else if (EppromUpdate() == 2) { EEPROM.write(7 , r); EEPROM.write(8 , g); EEPROM.write(9 , b); }
  } 
     else if (fade == 54){   
   if ( EppromUpdate() == 1)     { r = EEPROM.read(10); g = EEPROM.read(11); b = EEPROM.read(12);  }
   else if (EppromUpdate() == 2) {   EEPROM.write(10, r); EEPROM.write(11, g); EEPROM.write(12, b);  }
  } 
     else if (fade == 55){   
   if ( EppromUpdate() == 1)     { r = EEPROM.read(13); g = EEPROM.read(14); b = EEPROM.read(15);  }
   else if (EppromUpdate() == 2) { EEPROM.write(13, r); EEPROM.write(14, g); EEPROM.write(15, b); }
  } 
     else if (fade == 56){   
   if ( EppromUpdate() == 1)     { r = EEPROM.read(16); g = EEPROM.read(17); b = EEPROM.read(18);  }
   else if (EppromUpdate() == 2) {  EEPROM.write(16, r); EEPROM.write(17, g); EEPROM.write(18, b); }
  } 
